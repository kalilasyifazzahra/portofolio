...
import Blue from "@/app/tugasTigasatu/page";
import Green from "@/app/tugasTigaDua/page";
import Orange from "@/app/tugasTigatiga/page";
...
export default function Page() {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-200 min-h-screen w-full mt-4">
        <p className="ml-3 text-2xl mt-6">
          Widgets
          <span className="text-gray-400 text-base ml-2">Preview page</span>
        </p>
